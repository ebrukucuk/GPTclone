...
//html elementini oluşturur
const createElement = (html, className) => {
    //yeni bir div oluşturma
    const chatDiv = document.createElement("div");
    //verilen div e class ekleme
    chatDiv.classList.add("chat", className);
    //oluşturduğumuz dive dışardan gelen html parametresini gönderme
...
const getChatResponse = async (incomingChatDiv) => {
    ...
    //apiden gelen cevabı ekrana yazdırma
...
const handelOutGoingChat = () => { //trim sag sol fazladan boşluğu yokeder
    userText = chatInput.value.trim();     //chatınputun değerini alma
    if (!userText) return; //cahtInputun içi boşsa çalışma
...
//enter butonuna basıldığında istek at
...
sendButton.addEventListener("click", handelOutGoingChat);
...
deleteButton.addEventListener("click", () => {
    if (confirm("tüm sohbeti silmek istediğine emin misin?")) {
